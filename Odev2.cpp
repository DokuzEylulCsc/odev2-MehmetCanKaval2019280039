...
{ 
    ...
    if (r == 'M') 
        return 1000; 
        //küçük harf de kabul etmesi için yukardakinin aynýsýný küçük harflerle tekrarladým.
    if (r == 'i') 
        return 1; 
    if (r == 'v') 
        return 5; 
    ...
    return -1; // farklý bir sembol girildiðinde -1 deðerini veriyor 
} 
...
{ 
	...
	cout<<"Roma rakamlarını ondalık sayıya cevirmek için 1 e basiniz."<<endl;
	cout<<"Ondalık sayiyi Roma rakamlarina çevirmek için 2 e basiniz."<<endl;
	int secim;
	cin>>secim;
    if(secim==1) {
	cout<<"Ondalik sayiya çevirmek istediðiniz Roma rakamlarini giriniz"<<endl;
    string str;
	cin>>str; 
